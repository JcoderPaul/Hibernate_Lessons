...
@Builder
@Entity
@Table(name = "company", schema = "part_four_base")
/*
Данная аннотация устанавливается над текущим классом, а
не над полем в связном классе, например, User. Зато такой
вариант аннотирования класса позволит, в некоторой степени,
облегчить процесс загрузки данных из БД, за счет установки
размера Batch-a.
*/
@BatchSize(size = 3)
