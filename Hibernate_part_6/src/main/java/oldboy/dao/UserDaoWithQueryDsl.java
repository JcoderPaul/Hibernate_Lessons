...
public class UserDaoWithQueryDsl {

    private static final UserDaoWithQueryDsl INSTANCE = new UserDaoWithQueryDsl();

    public static UserDaoWithQueryDsl getInstance() {
        return INSTANCE;
    }
